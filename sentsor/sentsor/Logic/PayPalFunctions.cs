...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    using (sentsor.Logic.ShoppingCartActions myCartOrders = new sentsor.Logic.ShoppingCartActions())
    {
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
      // Log the exception.
      sentsor.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
